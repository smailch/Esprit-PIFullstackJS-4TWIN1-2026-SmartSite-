...
export class UsersController {
  ...
  /** Routes littérales en premier : sinon `GET :id` capture `auth`, `register`, etc. */
  @Post('register')
  ...
  /**
   * Avant @Get(':id') : sinon « client-accounts » est pris pour un id Mongo.
   * Staff uniquement (pas le rôle Client).
   */
  @UseGuards(JwtAuthGuard)
  @Get('client-accounts')
  listClientAccounts(
    ...
    return this.usersService.findClientAccounts();
  }
