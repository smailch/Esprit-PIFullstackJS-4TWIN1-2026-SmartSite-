        ...
        <div style={s.aiCardBody}>
          {aiLoading ? (
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', color: '#888' }}>
              <div style={{ width: '16px', height: '16px', border: '2px solid #e0e0e0',
                borderTopColor: '#132849', borderRadius: '50%', animation: 'spin 0.9s linear infinite' }} />
            ...
            {logs.length === 0 ? (
              ...
              return (
                <tr key={log._id} className="log-row" style={{
                  ...
                  {/* AI Reason */}
                  <td style={s.td}>
                    <span style={{ fontSize: '12px', color: '#666', fontStyle: log.reason ? 'normal' : 'italic' }}>
                      {log.reason || '—'}
                    </span>
                  </td>
...
const s = {
  ...
  headerIcon:    { width: '48px', height: '48px', borderRadius: '12px', backgroundColor: '#f0f4ff',
  ...
  unreadBadge:   { backgroundColor: '#ef4444', color: 'white', fontSize: '11px', fontWeight: '800',
  ...
  // AI Card
  aiCard: { backgroundColor: 'white', borderRadius: '16px', padding: '24px',
  ...
  aiIconWrap:   { width: '40px', height: '40px', borderRadius: '10px', backgroundColor: '#f5f3ff',
    display: 'flex', justifyContent: 'center', alignItems: 'center', flexShrink: 0 },
  aiCardTitle:    { fontSize: '15px', fontWeight: '700', color: '#1a1a2e' },
  aiCardSubtitle: { fontSize: '12px', color: '#888', marginTop: '2px' },
  aiBadge: { marginLeft: 'auto', backgroundColor: '#FACC15', color: '#000',
  ...
  statCard:  { flex: 1, minWidth: '120px', borderRadius: '12px', padding: '16px 20px',
  ...
  filterBtn: { padding: '8px 16px', borderRadius: '8px', cursor: 'pointer',
    fontWeight: '600', fontSize: '13px', transition: 'all 0.2s' },

  // Table
  tableCard: { backgroundColor: 'white', borderRadius: '16px',
    boxShadow: '0 4px 20px rgba(0,0,0,0.07)', overflow: 'hidden' },
  table:  { width: '100%', borderCollapse: 'collapse' },
  thead:  { backgroundColor: '#f8faff' },
  th: { padding: '14px 16px', textAlign: 'left', fontSize: '12px', fontWeight: '700',
  ...
  markOneBtn: { width: '28px', height: '28px', borderRadius: '6px', border: '1px solid #e0e0e0',
